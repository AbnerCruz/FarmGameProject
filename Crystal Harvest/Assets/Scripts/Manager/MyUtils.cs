...
public class MyUtils{
    public TextMesh CreateText(string _name, GameObject parent,string text, Vector2 position, int fontSize, Color color, TextAnchor textAnchor, TextAlignment textAlignment, int sortingOrder){
